...
class CustomTransform:
    def __init__(self, n_transforms, level, transform_list=None, n_datasets=20):
        if transform_list is None:
            ...
            custom_transform = transform_list
    ...
    def set_transform_indx(self, i):
        ...
        if self.rand_lvl:
            self.level = random.randint(10, 20)
        # print("Current transform:{}, level:{}".format(self.ops[self.transf_indx], self.level))
